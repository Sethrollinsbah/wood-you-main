...
interface EM1AttributeInterface
{
    public function getAttributes($pageSize, $pageIndex, $sortField, $sortDirection);

    public function getAttributeValues($attributeId, $pageSize, $pageIndex, $sortField, $sortDirection);

    public function getAttributesToGenerateCombinations();
    ...
    public function searchAttributes($searchValue, $pageSize, $pageIndex, $sortField, $sortDirection);
}
