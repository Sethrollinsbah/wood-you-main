...
<ul class="nav nav-tabs" id="wimhide">				
	<li id="tab1" class="active">
		<a href="#" id="general_tab">
			<i class="icon-home"></i>
			  {l s='Dashboard' mod='randomrain'}
		</a>
	</li>
	<li id="tab2">
		<a href="#" id="configuracion_tab">
			<i class="icon-database"></i>
			  {l s='Configuration' mod='randomrain'}
		</a>
	</li>
	<li id="tab3">
		<a href="#" id="ayuda_tab">
			<i class="icon-cogs"></i>
			  {l s='Help' mod='randomrain'}
		</a>
	</li>
...
<div class="tab-content panel">	
	...
	<h1><i class="icon icon-credit-card"></i> {l s='Template color change' mod='randomrain'}</h1>
    {$displayinfo}
	</div>
