...
class CompareWishlistProViewModuleFrontController extends ModuleFrontController
{
    public function __construct()
    {
        ...
        include_once $this->module->getLocalPath().'comparewishlistpro.php';
    }
    ...
    public function initContent()
    {
        ...
        if ($token) {
            ...
            $priority_names = array($module->l('High'), $module->l('Medium'), $module->l('Low'));
