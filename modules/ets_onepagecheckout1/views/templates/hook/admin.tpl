...
*}
<script type="text/javascript" src="{$ETS_OPC_MODULE_URL|escape:'html':'UTF-8'}views/js/admin.js"></script>
<script>
    var Click_to_enable_text= '{l s='Click to enable' mod='ets_onepagecheckout' js=1}';
    var Click_to_disable_text= '{l s='Click to disable' mod='ets_onepagecheckout' js=1}';
</script>
<div id="form_onepagecheckout" class="row">
    <div class="onepagecheckout-left col-md-3 col-lg-3">
        <ul id="list-tabs">
            <li class="tab{if !(isset($smarty.get.control) && $smarty.get.control=='additional')} active{/if}" data-tab="settings">
            ...
            {l s='General' mod='ets_onepagecheckout'}</li>
            <li class="tab" data-tab="account">
                <span class="ets_icon_svg">
            ...
            {l s='Shipping' mod='ets_onepagecheckout'}</li>
            <li class="tab" data-tab="payment">
                <span class="ets_icon_svg">
                    <svg viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1824 128q66 0 113 47t47 113v1216q0 66-47 113t-113 47h-1600q-66 0-113-47t-47-113v-1216q0-66 47-113t113-47h1600zm-1600 128q-13 0-22.5 9.5t-9.5 22.5v224h1664v-224q0-13-9.5-22.5t-22.5-9.5h-1600zm1600 1280q13 0 22.5-9.5t9.5-22.5v-608h-1664v608q0 13 9.5 22.5t22.5 9.5h1600zm-1504-128v-128h256v128h-256zm384 0v-128h384v128h-384z"/></svg>

                </span>
            {l s='Payment' mod='ets_onepagecheckout'}</li>
            <li class="tab" data-tab="design">
                <span class="ets_icon_svg">
            ...
            {l s='Design' mod='ets_onepagecheckout'}</li>
            <li class="tab" data-tab="additional">
                <span class="ets_icon_svg">
            ...
            {l s='Additional info' mod='ets_onepagecheckout'}</li>
            ...
            {l s='SEO' mod='ets_onepagecheckout'}</li>
        </ul>
    </div>
    <div class="onepagecheckout-right col-md-9 col-lg-9">
        {$form_html nofilter}
    </div>
</div>