...
<div class="card-block cart-summary-totals">
    ...
    {else}
      <div class="cart-summary-line cart-total">
        <span class="label">{$cart.totals.total_excluding_tax.label|escape:'html':'UTF-8'}&nbsp;{if isset($configuration.taxes_enabled) && $configuration.taxes_enabled}{$cart.labels.tax_short|escape:'html':'UTF-8'}{/if}</span>
