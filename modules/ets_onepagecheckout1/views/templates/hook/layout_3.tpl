...
*}
<form id="form_ets_onepagecheckout" class="layout layout_3" action="{$link->getModuleLink('ets_onepagecheckout','order')|escape:'html':'UTF-8'}" method="post">
    <div id="ets_onepagecheckout" class=" row">
        ...
        <div class="onepagecheckout-center col-lg-4">
            <div class="" {if !$shipping_methods} style="display:none"{/if}>
        ...
        <div class="onepagecheckout-right col-lg-4">
        ...
        <div class="onepagecheckout-footer col-lg-12">
