...
<div id="gc-success-modal" role="dialog">
	<div class="gcsm-header">
      <h4><i class="material-icons ta-icon">&#xE876;</i>{l s='Gift Card Successfully Added to Your Shopping Cart' mod='giftcard'}</h4>
    </div>
    <div class="gcsm-body">
    <div class="row">
      ...
      <div class="col-md-6">
              ...
              <a href="{$cart_url|escape:'htmlall':'UTF-8'}" class="btn btn-primary"><i class="material-icons">&#xE876;</i>{l s='proceed to checkout' mod='giftcard'}</a>
            </div>
      	</div>
    </div>
  </div>
