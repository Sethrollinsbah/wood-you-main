...
<div id="choicegiftcard" data-link-controller="{$linkcgc|escape:'htmlall':'UTF-8'}">
	...
	<p> {l s='Amount' mod='giftcard'}&nbsp;
      ...
      {*** BUTTON SUBMIT ***}
      <div class="ta-gc-submit">
	 	<button class="preview_form submit_button" type="button" disabled="disabled"  data-ta-action="preview">{l s='Preview' mod='giftcard'}</button>
	    <button class="submit_form submit_button" type="button" disabled="disabled"  data-ta-action="add_to_cart">{l s='Add to cart' mod='giftcard'}</button>
	    <div class="ease"></div>
	</div>
