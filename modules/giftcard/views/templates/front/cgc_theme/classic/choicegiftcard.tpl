	                ...
	                <div class="jcarousel" >
	                    <ul>
								...
								{foreach from=$templates item=template name=thumbnails}
			                        ...
			                        <li class="template_item template_item{$template.id_gift_card_template|intval} {if isset($template_default) && $template_default->id==$template.id_gift_card_template}js-template-default selected{/if}"  data-physicaluse="{$template.physicaluse|intval}" data-virtualuse="{$template.virtualuse|intval}">
