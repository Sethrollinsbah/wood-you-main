...
class Googlemybusinessreviews extends Module
{
    ...
    const HOOKS_SIMPLE_FORMAT = array('displayLeftColumn', 'displayReassurance', 'displayRightColumn');
    const HOOKS_SLIDER_FORMAT = array('displayFooterBefore', 'displayFooter', 'displayHome');
    ...
    protected function getVariablesReviews()
    {
        ...
        $reviews = Review::getAll($locale, $nbReviews);
        return
            array(
