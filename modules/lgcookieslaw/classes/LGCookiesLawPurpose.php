...
class LGCookiesLawPurpose extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'description' => [
                'type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml', 'required' => true
            ],
        ],
    ];
            ...
            self::PERFORMANCE_PURPOSE => [
                ...
                'description' => [
                    'es' => 'Se usan para mejorar la experiencia de navegación y optimizar el funcionamiento de la ' .
                        'tienda.',
                    'en' => 'These are used to improve the browsing experience and optimise the operation of the shop.',
                    ...
                    'gb' => 'These are used to improve the browsing experience and optimise the operation of the shop.',
                ],
                'technical' => false,
                'active' => true,
                'locked_modules' => [],
