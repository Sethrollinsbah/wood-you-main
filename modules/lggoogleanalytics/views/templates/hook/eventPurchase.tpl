...
<script type="text/javascript">
  gtag('event', 'purchase', {ldelim}
    affiliation: '{$event.affiliation|escape:'javascript':'UTF-8'}',
    ...
    {/foreach}],
    transaction_id: '{$event.transaction_id|escape:'javascript':'UTF-8'}',
    shipping: {$event.shipping|escape:'javascript':'UTF-8'},
    value: {$event.value|escape:'javascript':'UTF-8'},
    tax: {$event.tax|escape:'javascript':'UTF-8'}
  {rdelim});
</script>
