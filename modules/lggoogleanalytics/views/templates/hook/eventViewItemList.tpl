...
<script type="text/javascript">
  gtag('event', 'view_item_list', {ldelim}
    items: [
    ...
    {ldelim}
        ...
        item_list_name: '{$item.item_list_name|escape:'javascript':'UTF-8'}',
        item_list_id: '{$item.item_list_id|escape:'javascript':'UTF-8'}',
    ...
    item_list_name: '{$event.item_list_name|escape:'javascript':'UTF-8'}',
    item_list_id: '{$event.item_list_name|escape:'javascript':'UTF-8'}'
  });
</script>
