...
<div class="twa">
	{if !empty($page_header)}<h1>{$page_header|escape:'html':'UTF-8'}</h1>{/if}
	...
	<div id="loadMore" class="middle-line">
		<a class="neat" href="#">{l s='More reviews...' mod='testimonialswithavatars'}</a>
		...
		<form id="add_new_post" enctype="multipart/form-data">
			...
			<div class="new_content_wrapper">
				<div class="customer_name field">
					...
					<input type="text" value="{$customer_name|escape:'html':'UTF-8'}" name="customer_name" placeholder="{l s='Your Name' mod='testimonialswithavatars'}">
				</div>
