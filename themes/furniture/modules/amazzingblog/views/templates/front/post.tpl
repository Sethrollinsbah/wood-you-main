...
{if $post && $post.active}
<p class="title-blog">{l s='Blog' d='Shop.Modules.Amazzingblog'}</p>
	...
	{if !empty($settings.show_date)}
		...
		<div class="post-date inline-block">{$post.publish_from|date_format|escape:'html':'UTF-8'}</div>
	{/if}
	</div>
	<div class="wrapper-post-content">
		...
		<div class="wrapper-info">
			{if !empty($settings.show_author) || !empty($settings.show_views)}
			<div class="post-info info-block">
				{if !empty($settings.show_author)}
					...
					<div class="post-author inline-block">
						{*{l s='Posted by' d='Shop.Modules.Amazzingblog'}*}
		...
		{if !empty($settings.social_sharing)}
			<div class="post-sharing">
				{l s='Share' d='Shop.Modules.Amazzingblog'}
	...
	{if !empty($blog->general_settings.user_comments)}
		<div id="post-comments" class="post-comments">
			<h4><span class="comments-num">{$ab_comments|count|intval}</span> {l s='comments' d='Shop.Modules.Amazzingblog'}</h4>
