 ...
 *}
  <div id="search_filters">
    ...
    {/block}
    <div class="search_filters-wrapper">
            ...
            {if $facet.widgetType !== 'dropdown'}
              ...
              {block name='facet_item_other'}
                <ul id="facet_{$_expand_id}" class="collapse{if !$_collapse} in{/if}">
                  {foreach from=$facet.filters item="filter"}
                    {if $filter.displayed}
                      <li class="{if isset($filter.properties.color) && $facet.multipleSelectionAllowed}color-type{/if}">
                ...
                <a href="" class="filter-read-more">{l s='Lees meer' d='Shop.Custom'}</a>
                <a href="" class="filter-read-less">{l s='Verberg' d='Shop.Custom'}</a>
              {/block}
