...
/* Smarty version 3.1.48, created on 2025-01-07 11:40:02
  from '/home/u695283169/domains/woodyoubahamas.com/public_html/modules/ets_onepagecheckout/views/templates/hook/onepagecheckout.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_677d58e2afe6f1_53797381',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3fcbe4c1f01a7ff925b7957e1144973f5c06473d' => 
    array (
      0 => '/home/u695283169/domains/woodyoubahamas.com/public_html/modules/ets_onepagecheckout/views/templates/hook/onepagecheckout.tpl',
      1 => 1736189423,
      2 => 'file',
    ),
  ),
...
function content_677d58e2afe6f1_53797381 (Smarty_Internal_Template $_smarty_tpl) {
?><style>
...
';
var iso_code_state='';
var ets_opc_date_format_lite ='<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['date_format_lite']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
';
var countries = {};
var ETS_OPC_USE_NAME_ACCOUNT =<?php echo htmlspecialchars(intval(Configuration::get('ETS_OPC_USE_NAME_ACCOUNT')), ENT_QUOTES, 'UTF-8');?>
;
...
?>
        countries[<?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['country']->value['id_country']), ENT_QUOTES, 'UTF-8');?>
] ={};
        countries[<?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['country']->value['id_country']), ENT_QUOTES, 'UTF-8');?>
]['iso_code'] = '<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['country']->value['iso_code'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
';
        countriesNeedZipCode[<?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['country']->value['id_country']), ENT_QUOTES, 'UTF-8');?>
] = '<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['country']->value['zip_code_format'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
';
    <?php
}
...
>
    <?php echo '<script'; ?>
 src="https://maps.googleapis.com/maps/api/js?key=<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['ETS_OPC_GOOGLE_KEY_API']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
