...
/* Smarty version 3.1.48, created on 2025-01-07 11:43:51
  from '/home/u695283169/domains/woodyoubahamas.com/public_html/modules/lggoogleanalytics/views/templates/hook/eventPurchase.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_677d59c767d690_17130133',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8d754c31a8049ca2aeab39d552d547bf910664b9' => 
    array (
      0 => '/home/u695283169/domains/woodyoubahamas.com/public_html/modules/lggoogleanalytics/views/templates/hook/eventPurchase.tpl',
      1 => 1720095542,
      2 => 'file',
    ),
  ),
...
function content_677d59c767d690_17130133 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
 type="text/javascript">
  gtag('event', 'purchase', {
    affiliation: '<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['event']->value['affiliation'],'javascript','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
',
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>],
    transaction_id: '<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['event']->value['transaction_id'],'javascript','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
',
    shipping: <?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['event']->value['shipping'],'javascript','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
,
...
,
    tax: <?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['event']->value['tax'],'javascript','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
