...
/* Smarty version 3.1.48, created on 2025-01-09 14:42:19
  from '/home/u695283169/domains/woodyoubahamas.com/public_html/modules/whatsappchat/views/templates/hook/bo_orders_grid_action.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6780269b8d1101_26589645',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f2028aa39a27a2664040a63f709374edf22954ca' => 
    array (
      0 => '/home/u695283169/domains/woodyoubahamas.com/public_html/modules/whatsappchat/views/templates/hook/bo_orders_grid_action.tpl',
      1 => 1709033585,
      2 => 'file',
    ),
  ),
...
function content_6780269b8d1101_26589645 (Smarty_Internal_Template $_smarty_tpl) {
 ...
 type="text/javascript">
        var orders_list = {
            ...
            createListDropdown: function() {
                ...
                <?php if (version_compare((defined('_PS_VERSION_') ? constant('_PS_VERSION_') : null),'1.7.7','>=')) {?>
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['action']->value,'htmlall','UTF-8' ));
            ...
            createWhatsAppChatButton: function(id_order) {
                ...
                return $(document.createElement('a')).attr({'href': '#', 'data-toggle': 'pstooltip', 'data-placement': 'top', 'data-original-title': '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['action']->value,'htmlall','UTF-8' ));?>
', 'title':'<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['action']->value,'htmlall','UTF-8' ));?>
', 'data-clickable-row': '1', 'class': 'btn tooltip-link dropdown-item inline-dropdown-item', 'onclick': 'orders_list.getCustomerPhoneAndOpenWhatsAppChat(' + id_order + ')'}).html(whatsapp_icon).addClass('whatsappchat_button_li_' + id_order);
                <?php } else { ?>
...
"><i class="icon-whatsapp bo"></i><div><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['action_whatsappchat']->value,'htmlall','UTF-8' ));?>
                    ...
                    <?php }?>
                    var html = '<a id="whatsappchat_openanchor" <?php if (version_compare((defined('_PS_VERSION_') ? constant('_PS_VERSION_') : null),'1.7.7','>=')) {?>style="display:none;"<?php }?> class="btn btn-default" href="#" onclick="orders_list.openWhatsAppChat();return false;" ><i class="icon-whatsapp"></i> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['action_whatsappchat']->value,'htmlall','UTF-8' ));?>
</a>';
                    <?php if (version_compare((defined('_PS_VERSION_') ? constant('_PS_VERSION_') : null),'1.5','<')) {?>
                        $("#content div.col-lg-7 .panel:first .hidden-print:first").prepend(html);
                    <?php } elseif (version_compare((defined('_PS_VERSION_') ? constant('_PS_VERSION_') : null),'1.7.7','>=')) {?>
                    var whatsapp_icon = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="20px" height="20px" style="-ms-transform: rotate(360deg);-webkit-transform: rotate(360deg);transform: rotate(360deg);width: 20px;height: 20px;vertical-align: bottom;" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21c5.46 0 9.91-4.45 9.91-9.91c0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2m.01 1.67c2.2 0 4.26.86 5.82 2.42a8.225 8.225 0 0 1 2.41 5.83c0 4.54-3.7 8.23-8.24 8.23c-1.48 0-2.93-.39-4.19-1.15l-.3-.17l-3.12.82l.83-3.04l-.2-.32a8.188 8.188 0 0 1-1.26-4.38c.01-4.54 3.7-8.24 8.25-8.24M8.53 7.33c-.16 0-.43.06-.66.31c-.22.25-.87.86-.87 2.07c0 1.22.89 2.39 1 2.56c.14.17 1.76 2.67 4.25 3.73c.59.27 1.05.42 1.41.53c.59.19 1.13.16 1.56.1c.48-.07 1.46-.6 1.67-1.18c.21-.58.21-1.07.15-1.18c-.07-.1-.23-.16-.48-.27c-.25-.14-1.47-.74-1.69-.82c-.23-.08-.37-.12-.56.12c-.16.25-.64.81-.78.97c-.15.17-.29.19-.53.07c-.26-.13-1.06-.39-2-1.23c-.74-.66-1.23-1.47-1.38-1.72c-.12-.24-.01-.39.11-.5c.11-.11.27-.29.37-.44c.13-.14.17-.25.25-.41c.08-.17.04-.31-.02-.43c-.06-.11-.56-1.35-.77-1.84c-.2-.48-.4-.42-.56-.43c-.14 0-.3-.01-.47-.01z" fill="#6c868e"></path></svg>';
                    ...
                    wa_button.find('button').removeClass('js-print-order-view-page').addClass('js-whatsappchat-order-view-page').html(whatsapp_icon + '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['action_whatsappchat']->value,'htmlall','UTF-8' ));?>
');
                    wa_button.find('button').attr('onclick', 'orders_list.getCustomerPhoneAndOpenWhatsAppChat("<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['wa_id_order']->value,'htmlall','UTF-8' ));?>
");return false;');
                    ...
                    <?php } elseif (version_compare((defined('_PS_VERSION_') ? constant('_PS_VERSION_') : null),'1.6','>=')) {?>
                        $("#content div.col-lg-7 .panel:first .hidden-print:first").prepend(html);
                    <?php } else { ?>
                        html = '<a class="toolbar_btn" href="#" onclick="orders_list.openWhatsAppChat();return false;" ><span class="icon-whatsapp"><img src="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['this_path_bo']->value,'htmlall','UTF-8' ));?>
