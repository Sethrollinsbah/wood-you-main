...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    ...
    'You can\'t manage your stock in this shop context: select a shop instead of a group of shops.' => 'You can\'t manage your stock in this store context: select a store instead of a group of stores.',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.',
    ...
    'You are editing this page for a specific shop or group. Click "Yes" to check all fields, "No" to uncheck all.' => 'You are editing this page for a specific store or group. Click "Yes" to check all fields, "No" to uncheck all.',
...
Thanks for your patience.',
  ...
  array (
    ...
    'Follow your order and download your invoice on our shop, go to the <a href="{history_url}" target="_blank">Order history and details</a> section of your customer account.' => 'Follow your order and download your invoice on our store, go to the <a href="{history_url}" target="_blank">Order history and details</a> section of your customer account.',
    'Out of stock' => 'Out of stock',
  ...
  array (
    ...
    'Shipping and payment' => 'Shipping and payment',
    'All prices are mentioned tax included' => 'All prices are mentioned VAT included',
    'All prices are mentioned tax excluded' => 'All prices are mentioned VAT excluded',
    'and' => 'and',
    'shipping excluded' => 'shipping excluded',
    'Information' => 'Information',
  ),
  ...
  array (
    ...
    'Gift wrapping' => 'Gift wrapping',
    'Shipping' => 'Shipping',
    'Included taxes' => 'Included VAT',
    'Taxes' => 'Taxes',
    'Total (tax incl.)' => 'Total (VAT incl.)',
    'Total (tax excl.)' => 'Total (VAT excl.)',
    '1 item' => '1 item',
    '%count% items' => '%count% items',
    'A minimum shopping cart total of %amount% (tax excl.) is required to validate your order. Current cart total is %total% (tax excl.).' => 'A minimum shopping cart total of %amount% (VAT excl.) is required to validate your order. Current cart total is %total% (VAT excl.).',
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    '%modifiedfiles% files will be modified, %deletedfiles% files will be deleted (if they are found).' => '%modifiedfiles% files will be modified, %deletedfiles% files will be deleted (if they are found).',
    'File %s does not exist. Unable to select that channel.' => 'File %s does not exist. Unable to select that channel.',
    'Unable to retrieve version from zip: %s.' => 'Unable to retrieve version from zip: %s.',
    'Prestashop version detected in the xml (%s) does not match the zip version (%s).' => 'Prestashop version detected in the xml (%s) does not match the zip version (%s).',
    'Upgrade process will use archive.' => 'Upgrade process will use archive.',
    'Version number is missing. Unable to select that channel.' => 'Version number is missing. Unable to select that channel.',
    'Error on saving configuration' => 'Error on saving configuration',
    'Configuration successfully updated.' => 'Configuration successfully updated.',
    ...
    'File extraction complete. Now backing up files...' => 'File extraction complete. Now backing up files...',
    'Upgrade process done, but some warnings have been found.' => 'Upgrade process done, but some warnings have been found.',
    'Upgrade process done. Congratulations! You can now reactivate your shop.' => 'Upgrade process done. Congratulations! You can now reactivate your shop.',
    '%s removed' => '%s removed',
    'Please remove %s by FTP' => 'Please remove %s by FTP',
    ...
    '[ERROR] Unable to find files to upgrade.' => '[ERROR] Unable to find files to upgrade.',
    '%s files will be upgraded.' => '%s files will be upgraded.',
    'Updating module %module%...' => 'Updating module %module%...',
    '[WARNING] Error when trying to retrieve module %s instance.' => '[WARNING] Error when trying to retrieve module %s instance.',
    'Module %s does not need to be migrated. Module is up to date.' => 'Module %s does not need to be migrated. Module is up to date.',
    '%s modules left to upgrade.' => '%s modules left to upgrade.',
    'Addons modules files have been upgraded.' => 'Addons modules files have been upgraded.',
    '%s modules will be upgraded.' => '%s modules will be upgraded.',
    'Starting upgrade...' => 'Starting upgrade...',
    'Downloading and unzipping steps have been skipped, upgrade process will now remove sample data.' => 'Downloading and unzipping steps have been skipped, upgrade process will now remove sample data.',
    'Shop deactivated. Now backing up files...' => 'Shop deactivated. Now backing up files...',
    'Downloading step has been skipped, upgrade process will now unzip the local archive.' => 'Downloading step has been skipped, upgrade process will now unzip the local archive.',
    'Shop deactivated. Extracting files...' => 'Shop deactivated. Extracting files...',
    'Shop deactivated. Now downloading... (this can take a while)' => 'Shop deactivated. Now downloading... (this can take a while)',
    'Downloaded archive will come from %s' => 'Downloaded archive will come from %s',
    ...
    'No XML file has been selected.' => 'No XML file has been selected.',
    'No archive and no XML file have been selected.' => 'No archive and no XML file have been selected.',
    '[SKIP] directory "%s" does not exist and cannot be emptied.' => '[SKIP] directory "%s" does not exist and cannot be emptied.',
    '[CLEANING CACHE] File %s removed' => '[CLEANING CACHE] File %s removed',
    'Cleaning file cache' => 'Cleaning file cache',
    'Running opcache_reset' => 'Running opcache_reset',
    'You already have the %s version.' => 'You already have the %s version.',
    'Initializing required environment constants' => 'Initializing required environment constants',
    'Checking version validity' => 'Checking version validity',
    'Checking connection to database' => 'Checking connection to database',
    'Invalid database configuration' => 'Invalid database configuration',
    'Disabling all non native modules' => 'Disabling all non native modules',
    'Keeping non native modules enabled' => 'Keeping non native modules enabled',
    'Updating database data and structure' => 'Updating database data and structure',
    'Running generic queries' => 'Running generic queries',
    'Database upgrade OK' => 'Database upgrade OK',
    'Upgrading languages' => 'Upgrading languages',
    'Regenerating htaccess' => 'Regenerating htaccess',
    'Cleaning XML files' => 'Cleaning XML files',
    'Disabling overrides' => 'Disabling overrides',
    'Keeping overrides in place' => 'Keeping overrides in place',
    'Warning detected during upgrade.' => 'Warning detected during upgrade.',
    'Database upgrade completed' => 'Database upgrade completed',
    '%s is not a valid version number.' => '%s is not a valid version number.',
    '[ERROR] Version to install is too old.' => '[ERROR] Version to install is too old.',
    ...
    'Cannot find the SQL upgrade files. Please check that the %s folder is not empty.' => 'Cannot find the SQL upgrade files. Please check that the %s folder is not empty.',
    '[DROP] SQL %s table has been dropped.' => '[DROP] SQL %s table has been dropped.',
    'Keeping current theme' => 'Keeping current theme',
    'Switching to default theme.' => 'Switching to default theme.',
    'Upgrade the RTL files of back-office themes.' => 'Upgrade the RTL files of back-office themes.',
    'Upgrade the RTL files of front-office themes.' => 'Upgrade the RTL files of front-office themes.',
    'Download of the language pack %lang% failed. %details%' => 'Download of the language pack %lang% failed. %details%',
    'Error while updating translations for the language pack %lang%. %details%' => 'Error while updating translations for the language pack %lang%. %details%',
    '%lang% is not a valid iso code, skipping' => '%lang% is not a valid iso code, skipping',
    'Downloading language pack for %lang%' => 'Downloading language pack for %lang%',
    'Installing %lang% language pack' => 'Installing %lang% language pack',
    'Generating mail templates for %lang%' => 'Generating mail templates for %lang%',
    'Cannot generate email templates: %s.' => 'Cannot generate email templates: %s.',
    'API keys not present in parameters, generating' => 'API keys not present in parameters, generating',
    'Keys generated using openssl_pkey_new, exporting private and public keys' => 'Keys generated using openssl_pkey_new, exporting private and public keys',
    'Updating parameters file' => 'Updating parameters file',
    'Unable to migrate parameters' => 'Unable to migrate parameters',
    'Invalidating opcache for parameters file' => 'Invalidating opcache for parameters file',
    'Parameters file updated' => 'Parameters file updated',
    '[ERROR] %dir% does not exist or is not a directory.' => '[ERROR] %dir% does not exist or is not a directory.',
    '[ERROR] %s does not exist or is not a directory.' => '[ERROR] %s does not exist or is not a directory.',
    '[WARNING] An error occurred while downloading module %s, the received file is empty.' => '[WARNING] An error occurred while downloading module %s, the received file is empty.',
    'Local module %s successfully copied.' => 'Local module %s successfully copied.',
    'Can not found or copy local module %s. Trying to download it from Addons.' => 'Can not found or copy local module %s. Trying to download it from Addons.',
    '[WARNING] No response from Addons server.' => '[WARNING] No response from Addons server.',
    '[WARNING] Unable to write module %s\'s zip file in temporary directory.' => '[WARNING] Unable to write module %s\'s zip file in temporary directory.',
    'Module %s has been successfully downloaded from Addons.' => 'Module %s has been successfully downloaded from Addons.',
    'No version present in database for module %s, all files for upgrade will be applied.' => 'No version present in database for module %s, all files for upgrade will be applied.',
    '(%s/%s) Applying migration file %s.' => '(%s/%s) Applying migration file %s.',
    '[WARNING] Method %s already exists. Migration for module %s aborted, you can try again later on the module manager. Module %s disabled.' => '[WARNING] Method %s already exists. Migration for module %s aborted, you can try again later on the module manager. Module %s disabled.',
    '[WARNING] Method %s does not exist. Module %s disabled.' => '[WARNING] Method %s does not exist. Module %s disabled.',
    '[WARNING] Migration failed while running the file %s. Module %s disabled.' => '[WARNING] Migration failed while running the file %s. Module %s disabled.',
    '[WARNING] Unexpected error when trying to upgrade module %s. Module %s disabled.' => '[WARNING] Unexpected error when trying to upgrade module %s. Module %s disabled.',
    '[WARNING] Module %s version could not be updated. Database might be unavailable.' => '[WARNING] Module %s version could not be updated. Database might be unavailable.',
    '[WARNING] Error when trying to extract module %s.' => '[WARNING] Error when trying to extract module %s.',
    '[NOTICE] File %s does not exist, merge skipped.' => '[NOTICE] File %s does not exist, merge skipped.',
    '[WARNING] %variablename% variable missing in file %filename%. Merge skipped.' => '[WARNING] %variablename% variable missing in file %filename%. Merge skipped.',
    '[WARNING] %variablename% variable missing in file %filename%. File %filename% deleted and merge skipped.' => '[WARNING] %variablename% variable missing in file %filename%. File %filename% deleted and merge skipped.',
    'Unable to create directory %s' => 'Unable to create directory %s',
    'Cannot write to the directory. Please ensure you have the necessary write permissions on "%s".' => 'Cannot write to the directory. Please ensure you have the necessary write permissions on "%s".',
    'Error when trying to add %filename% to archive %archive%.' => 'Error when trying to add %filename% to archive %archive%.',
    '%filename% added to archive. %filescount% files left.' => '%filename% added to archive. %filescount% files left.',
    'Could not close the Zip file: %toFile% properly. Check you are allowed to write on the disk and there is available space on it.' => 'Could not close the Zip file: %toFile% properly. Check you are allowed to write on the disk and there is available space on it.',
    '%s is not a file' => '%s is not a file',
    'Unable to create directory %s.' => 'Unable to create directory %s.',
    ...
    'Unable to create file %s' => 'Unable to create file %s',
    'Error when trying to delete backups %s' => 'Error when trying to delete backups %s',
    'The module %s requires PHP %s to work properly. Please upgrade your server configuration.' => 'The module %s requires PHP %s to work properly. Please upgrade your server configuration.',
    'Activity Log' => 'Activity Log',
    'Currently processing' => 'Currently processing',
    'Analyzing the situation...' => 'Analyzing the situation...',
    'Errors' => 'Errors',
    'Report a bug' => 'Report a bug',
    'Give feedbacks' => 'Give feedbacks',
    'Email' => 'Email',
    'Description' => 'Description',
    'Give us details about the error' => 'Give us details about the error',
    'Cancel' => 'Cancel',
    ...
    'Your current PHP version isn\'t compatible with your PrestaShop version. (Expected: %s - %s | Current: %s)' => 'Your current PHP version isn\'t compatible with your PrestaShop version. (Expected: %s - %s | Current: %s)',
    'We were unable to check your PHP compatibility with the destination PrestaShop version.' => 'We were unable to check your PHP compatibility with the destination PrestaShop version.',
    ...
    'Your restoration is complete' => 'Your restoration is complete',
    'Before continuing with your tasks, please review the following checklist to ensure smooth operation after recent recovery.' => 'Before continuing with your tasks, please review the following checklist to ensure smooth operation after recent recovery.',
    'If you can\'t access your back office, try emptying the cache.' => 'If you can\'t access your back office, try emptying the cache.',
    'Open developer documentation' => 'Open developer documentation',
    'Next steps' => 'Next steps',
    'Disable the maintenance mode in General settings > Maintenance.' => 'Disable the maintenance mode in General settings > Maintenance.',
    'Troubleshooting' => 'Troubleshooting',
    'Your store is up to date' => 'Your store is up to date',
    'Before continuing with your tasks, please review the following checklist to ensure smooth operation after recent updates' => 'Before continuing with your tasks, please review the following checklist to ensure smooth operation after recent updates',
    'Re-enable and check your modules one by one.' => 'Re-enable and check your modules one by one.',
    'Make sure your store\'s front office is working properly: try to create an account, place an order, add a product, etc.' => 'Make sure your store\'s front office is working properly: try to create an account, place an order, add a product, etc.',
    'If some images don\'t appear in the front office, try regenerating thumbnails in Preferences > Images.' => 'If some images don\'t appear in the front office, try regenerating thumbnails in Preferences > Images.',
    'If something\'s wrong, you can restore a backup with this module. Your backup is available at {admin}/autoupgrade/backup.' => 'If something\'s wrong, you can restore a backup with this module. Your backup is available at {admin}/autoupgrade/backup.',
    'If you can\'t access your back office, try enabling the debug mode manually in config/defines.inc.php by setting _PS_MODE_DEV_ to true.' => 'If you can\'t access your back office, try enabling the debug mode manually in config/defines.inc.php by setting _PS_MODE_DEV_ to true.',
    'Rollback' => 'Rollback',
