...
class __TwigTemplate_ed28183364b3abff73493f15ebb2a451780afa110b8c888e265c919528da1f70 extends \Twig\Template
{
    ...
    ";
        ...
        <a class=\"nav-link active\" data-toggle=\"tab\" href=\"#tab_modules_list_not_installed\" role=\"tab\">
          ";
                // line 28
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Not Installed", [], "Modules.Mbo.Recommendedmodulesandservices"), "html", null, true);
                echo "
        </a>
      </li>
    ";
        ...
        <a class=\"nav-link";
          ...
          ";
                // line 35
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Installed", [], "Modules.Mbo.Recommendedmodulesandservices"), "html", null, true);
                echo "
        </a>
      </li>
    ";
        ...
        <table class=\"table\">
          ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["recommendedModuleNotInstalled"]) {
                    // line 45
                    echo "            ";
                    echo twig_include($this->env, $context, "@Modules/ps_mbo/views/templates/admin/controllers/module_catalog/Includes/tab-module-line.html.twig", ["module" => $context["recommendedModuleNotInstalled"]]);
                    echo "
          ";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
        ...
        <table class=\"table\">
          ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["recommendedModuleInstalled"]) {
                    // line 54
                    echo "            ";
                    echo twig_include($this->env, $context, "@Modules/ps_mbo/views/templates/admin/controllers/module_catalog/Includes/tab-module-line.html.twig", ["module" => $context["recommendedModuleInstalled"]]);
                    echo "
          ";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
  ...
  <div class=\"alert alert-addons row-margin-top\" role=\"alert\">
    <p class=\"alert-text\">
      <a href=\"";
        // line 64
        echo twig_escape_filter($this->env, ($context["recommendedModulesLinkToAddons"] ?? null), "html", null, true);
        echo "\" onclick=\"return !window.open(this.href);\">
        ";
        // line 65
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("More similar modules on Prestashop Marketplace", [], "Modules.Mbo.Recommendedmodulesandservices"), "html", null, true);
        echo "
      </a>
...
";
    ...
    {
        return array (  195 => 65,  191 => 64,  186 => 61,  182 => 59,  177 => 56,  160 => 54,  143 => 53,  135 => 51,  132 => 50,  127 => 47,  110 => 45,  93 => 44,  89 => 42,  87 => 41,  83 => 39,  76 => 35,  70 => 34,  63 => 33,  60 => 32,  53 => 28,  49 => 26,  47 => 25,  44 => 24,  41 => 23,  38 => 22,  29 => 20,);
    }
    ...
    {
        return new Source("", "@Modules/ps_mbo/views/templates/admin/controllers/module_catalog/recommended-modules.html.twig", "/home/u695283169/domains/woodyoubahamas.com/public_html/modules/ps_mbo/views/templates/admin/controllers/module_catalog/recommended-modules.html.twig");
    }
}
